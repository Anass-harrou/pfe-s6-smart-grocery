...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 24 mars 2025 à 13:21
...
(2, NULL, NULL, 'fatima@msala.com', 2),
(3, NULL, NULL, 'nada@harrou.com', 3);
...
INSERT INTO `produit` (`id_produit`, `nom`, `prix`, `quantite`, `disponibilite`, `code_barre`, `poids`, `image_url`) VALUES
(1, 'eau miniral 2L', 6, 10, 1, '1111111111', 0, 'images/sidi-ali-pack-4x2l.jpg'),
(2, 'atay sba3', 20, 1, 1, '222222222', 0, 'uploads/67e0c9f0bb7c0_1742785008.jpeg'),
(3, 'abtal', 2, 6, 1, '3333333333', 0, 'uploads/67e14286a13b1_1742815878.jpeg');
...
(2, 'tms', 'temsaman', '$2y$10$rNqICi8WKYeNg2j4F4T2sOzh0d3vdd2pOvwsQ8Tyf0Gn7sMH1Ml72', '2025-03-24 02:13:55'),
(3, 'Nada ', 'bayssa', '$2y$10$XVCoYIh.3e2.MMc9eSEJauRR4gSiiBfB7.nG1ZmowY0OX2UkIkq4i', '2025-03-24 11:28:56');
