...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow mb-4">
  <div class="container-fluid">
    ...
    <!-- Texte centré -->
    <div class="mx-auto fw-bold h5 text-center">
    <?php echo "Bienvenue en tant que ".$_SESSION['user']['username']; ?>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . htmlspecialchars($row['num_commande']) . "</td>";
                                        echo "<td>";
                    ...
                    mysqli_close($link);
                    ?>
                    <a class="navbar-brand" href="historique.php">historique des achat</a>
                </div>
            </div>
        </div>
    </div>
